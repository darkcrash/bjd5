...
namespace WebServerTest
{
    ...
    public class HttpServerTestNotSupported : ILife, IDisposable, IClassFixture<HttpServerTestFixture>
    {
         int portv4 = 7088;
         int portv6 = 7088;
        ...
        public HttpServerTestNotSupported(HttpServerTestFixture fixture)
        {
