...
namespace Bjd.Utils
{
    ...
    static public class MLang
    {
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                if (bytes[i] == 0x1b)
                {
                    ...
                    else if (i < len - 5)
                    {
                        ...
                        var b5 = bytes[i + 4];
                        var b6 = bytes[i + 5];
                        if (b2 == 0x26 && b3 == 0x40 && b4 == 0x1B && b5 == 0x24 && b6 == 0x42)
                        {// ESC&@ESC$B 
                            isJis = true;
                            break;
                        }
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                else if (i < len - 1)
                {
                    ...
                    else if (i < len - 2)
                    {
                        ...
                        else if ((b1 >= 0xE0 && b1 <= 0xEF) && (b2 >= 0x80 && b2 <= 0xBF) && (b3 >= 0x80 && b3 <= 0xBF))
                        { // 3バイト文字
                            i += 2;
                            utf8 += 2;
                        }
        ...
        public static Encoding GetEncoding(ArraySegment<byte> bytes)
        {
            ...
            //【日本語JISかどうかの判定】
            var isJis = false;
            for (var i = bytes.Offset; i < len; i++)
            {
                var ary = bytes.Array;
                if (ary[i] > 0x7F)
                {
        ...
        public static Encoding GetEncoding(BufferData bytes)
        {

            var len = bytes.DataSize;
            if (len > 1500)
                len = 1500;
