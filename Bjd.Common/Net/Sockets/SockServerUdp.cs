...
namespace Bjd.Net.Sockets
{
    public class SockServerUdp : SockObj
    {
        ...
        {
            Kernel.Logger.TraceInformation($"SockServer..ctor{protocolKind.ToString()}");
        ...
        {
            Kernel.Logger.TraceInformation($"SockServer.Bind UDP Start {bindIp.ToString()} {port.ToString()} ");
            _bindIp = bindIp;
            _bindPort = port;
        ...
        {
            Kernel.Logger.TraceInformation($"SockServer.BeginReceiveUdp");
            // UDP
        ...
        {
            Kernel.Logger.TraceInformation($"SockServer.Select");
