...
{
    public class ServerTestData : ILife, IDisposable
    {

        public class SmtpTestServer : TestServer
        {
            public SmtpTestServer() : base(TestServerType.Smtp, "ServerTestData.ini")
            {
        ...
        public ServerTestData(ITestOutputHelper output)
        {
