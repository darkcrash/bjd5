...
{
    public class ServerTestRcpt : ILife, IDisposable, IClassFixture<ServerTestRcpt.SmtpTestServer>
    {
        ...
        public ServerTestRcpt(ITestOutputHelper output, SmtpTestServer server)
        {
            _testServer = server;
