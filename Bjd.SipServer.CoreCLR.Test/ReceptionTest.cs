...
namespace SipServerTest {
    ...
    public class ReceptionTest :IDisposable {
        ...
        [Theory]
        [InlineData("lines_0", ReceptionKind.Request)]
        [InlineData("lines_1", ReceptionKind.Status)]
        [InlineData("lines_2", ReceptionKind.Request)]
        [InlineData("lines_3", ReceptionKind.Request)]
        ...
        [Theory]
        [InlineData("lines_0", SipMethod.Register)]
        [InlineData("lines_1", SipMethod.Unknown)]//異常系
        [InlineData("lines_2", SipMethod.Invite)]
        [InlineData("lines_3", SipMethod.Invite)]
        ...
        [Theory]
        [InlineData("lines_0", 0)]//異常系
        [InlineData("lines_1", 401)]
        [InlineData("lines_2", 0)]//異常系
        [InlineData("lines_3", 0)]//異常系
        ...
        [Theory]
        [InlineData("lines_0", "User-Agent", "snom105-2.04g")]
        [InlineData("lines_1", "User-Agent", "Asterisk PBX")]
        [InlineData("lines_2", "User-Agent", "Windows RTC/1.0")]
        [InlineData("lines_3", "User-Agent", "X-Lite release 4.5.5  stamp 71236")]
        ...
        [Theory]
        [InlineData("lines_0",0)]
        [InlineData("lines_1", 0)]
        [InlineData("lines_2", 18)]
        [InlineData("lines_3", 0)]
